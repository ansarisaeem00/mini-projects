...
namespace DiskSchedulingAlgorithms
{
    ...
    public partial class MainForm : Form
    {
        ...
        private void DrawGid(PaintEventArgs e)
        {
            ...
            e.Graphics.DrawLine(Pens.Blue, widthSize + startWidth, 0, widthSize + startWidth, this.Height);
            e.Graphics.DrawLine(Pens.Blue, startWidth, 0, startWidth, this.Height);
            e.Graphics.DrawLine(Pens.Blue, startWidth, startHeight, widthSize + startWidth, startHeight);
